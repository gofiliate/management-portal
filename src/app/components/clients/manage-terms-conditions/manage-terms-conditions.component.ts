...
@Component({
  selector: 'app-manage-terms-conditions',
  standalone: true,
        ...
        <div class="col-12">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
              ...
              <p class="text-muted mb-0">
                Configure platform terms and conditions for Instance #{{ instanceId }}
              </p>
            </div>
          ...
          <div class="card">
            <div class="card-body text-center py-5">
              ...
              <h5 class="text-muted mb-2">Terms & Conditions Management</h5>
...
export class ManageTermsConditionsComponent implements OnInit {
  public instanceId = 0;
